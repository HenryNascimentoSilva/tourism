...
function Card({ img, name, date, firstImage, secondImage, thirdImage }) {
    ...
    <>
      <div className="flex flex-col rounded-lg overflow-hidden shadow-md hover:shadow-2xl duration-500 bg-slate-100 mt-10">
        ...
        <div className="grid lg:grid-cols-2 lg:gap-10 gap-5 px-4 pt-1 pb-4">
          <button type="button" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" onClick={handleOpenModal}>
            Saiba Mais
          </button>
      ...
      <Modal isOpen={isModalOpen} onClose={handleCloseModal} img1={firstImage} img2={secondImage} img3={thirdImage}>
